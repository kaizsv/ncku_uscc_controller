...
schedule = [
    {
        ...
        'action':[{'actuator':{'CID':cid, 'DID':0, 'TYPE':'AW', 'TID':1, 'ADDRESS':40000}, 'value':1}],
        'period':{'start_time':14, 'duration':0},
        'rule_make_time':time.strftime("%Y-%m-%d %H:%M:%S")
    },
    {
        'condition':None,
        'action':[{'actuator':{'CID':cid, 'DID':1, 'TYPE':'AW', 'TID':5, 'ADDRESS':40005}, 'value':1}, {'actuator':{'CID':cid, 'DID':1, 'TYPE':'AW', 'TID':6, 'ADDRESS':40006}, 'value':0},{'actuator':{'CID':cid, 'DID':1, 'TYPE':'AW', 'TID':7, 'ADDRESS':40007}, 'value':1}],
